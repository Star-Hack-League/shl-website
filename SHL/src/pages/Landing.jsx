...
import buttonletsgo from "/images/buttonletsgo.png";
import dottedline from "/images/dottedline.png";
import ucontainer from "/images/ucontainer.png";
      ...
      <div id="container" ref={this.container}>
          ...
          <div className="landing-section-container">
            ...
            <center>
              <h1 className="heading">
                The{" "}
                <div className="next-text-gradient animate__animated animate__fadeIn animate__slow">
                  Alliance
                </div>{" "}
                of
                <br />
            ...
            />
            <img
              className="crown animate__animated animate__bounceInUp animate__slow"
              src={crown}
              alt="Crown"
            />
          </div>
        ...
        <div className="page second-page">
          <div className="second-page-container">
            <div className="second-page-text">
              ...
              <div className="next-text-gradient ">
                NEXT LEVEL <br />{" "}
              </div>
              <p className="paragraph">
                Elevate your event with our connected
                <br />
        ...
        <div className="page third-page">
          <div className="second-page-container">
            <div className="second-page-text">
              ...
              <br />
              <p className="paragraph">
                Gain Next-Level Event Support Tailored to
                <br />
                Your Needs.
              </p>
            </div>
        ...
        <div className="page third-page">
          <div className="second-page-container">
            <div className="second-page-text">
              <h1 className="heading">
                <div className="next-text-gradient ">EVENTS </div>{" "}
              </h1>
              <p className="paragraph">
                Join a unique league of events for all skill
                <br />
                levels.
              </p>
            </div>
            <img className="ucontainer" src={ucontainer} alt="UContainer" />
            <img className="button" src={buttonletsgo} />
            <img className="dottedline" src={dottedline} />
          </div>
        </div>
        <div className="page third-page">
          <div className="second-page-container">
            <div className="second-page-text">
              ...
              <p className="paragraphtwo">
                Enter your details and a Star Hack
                <br />
                Representative will be with you as soon
                <br />
                as possible.
              </p>
            </div>
