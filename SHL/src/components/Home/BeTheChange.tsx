			...
			<div className="bethechange-inner-wrapper">
				...
				<div className="links-wrapper">
					<Link
						...
						href="/youtube"
					/>
					<Link text="@starhackalliance" icon="/insta.svg" href="/youtube" />
					<Link text="@starhackleague" icon="/youtube.svg" href="/youtube" />
					<Link text="@starhackalliance" icon="/tiktok.svg" href="/youtube" />
					<Link
